...
const Card2 = ({ img,userInfo , smallInfo,caption  , time,date}) => {
    return (
            ...
            <Box sx={{height:{md:"450px",sm:"520px"},background:"white",mb:4,boxShadow:"rgba(2, 151, 157, 0.1) 0px 8px 24px","&:hover":{boxShadow:"rgba(2, 74, 157, 0.2) 0px 8px 24px",transform:"translateY(-1px)"}}}>
                ...
                <Button style={{width:"50px",height:"30px",margin:"10px auto 0px",borderRadius:"15px"}} ><RightArrow fontSize="small"/> </Button>
            </Box>
