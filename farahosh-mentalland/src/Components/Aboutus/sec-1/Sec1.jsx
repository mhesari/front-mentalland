...
const Sec1 = ()=>{
    return (
        <Box sx={{marginTop:{md:"150px"},textAlign:"center",width:"90%",mx:"auto"}}>
            <Typography sx={{fontSize:"45px",fontFamily:"alice-regular"}}>We are here to make your life Easier</Typography>
            <Typography sx={{fontFamily:"Gilroy-Regular",lineHeight:"38px" , width:"100%",marginTop:"5px",fontSize:"22px",textAlign:"justify"}}>
