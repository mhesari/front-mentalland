...
const Homesection2 = () => {
    return ( 
        <div>
            ...
            <div className="flex flex-col align-middle  justify-items-start  items-start">
  ...
  alignItems="center">
                ...
                <div className={styles.section2_pic}><div className={styles.section2_pic__shadow}></div><img alt="" src={Pic3} /><p>being the first
