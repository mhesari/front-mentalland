...
import S1 from "../../../assests/image/Arts-Adults/Rectangle 129.png";
      ...
      <ZPattern zPatternType="zPatternLtr">
        ...
        >
          <div className="z-pattern-image">
            <img src={S1} className={style.img}/>
          </div>
          <div className="z-pattern-text">
            <h2 className={style.title} >BE AN ACTOR/ACTRESS IN MENTALLAND ART DEPARTMENT</h2>
