...
const ImageSlider = () => {
    ...
    return ( 
        <>
                ...
                <Box sx={{overflowY:"visible",pt:15,pb:10}}>
                <Typography sx={{fontFamily:"alice-regular",fontSize:{lg:"40px",xs:"20px"},py:{xs:0,md:2},mb:{md:25,xs:4},textAlign:"center"}}>WHAT OUR PATIENTS SAY ABOUT US</Typography>
