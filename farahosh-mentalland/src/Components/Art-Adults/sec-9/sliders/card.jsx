...
const Card2 = ({ img,name , field}) => {
    return (
            ...
            <Box className="card" sx={{width:{xs:"100%",md:"90%"},height:{xl:"370px",lg:"280px",md:"250px",sm:"500px",xs:"450px"},borderRadius:"14px",background:"white",mb:{xs:0,md:4},boxShadow:"rgba(2, 151, 157, 0.1) 0px 8px 24px","&:hover":{boxShadow:"rgba(2, 74, 157, 0.2) 0px 8px 24px",transform:"translateY(-1px)"}}}>
