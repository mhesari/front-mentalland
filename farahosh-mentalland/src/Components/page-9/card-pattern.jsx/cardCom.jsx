        ...
        <>
            <Grid xs={12} md={6} >
                <Box sx={{p:2 ,m:1, border:"2px solid #E6F0F6",zIndex:"999"}}>
                    ...
                    <Typography sx={{color:"black",fontFamily:"Gilroy-Regular",fontSize:"18px",fontStyle:"body-med",lineHeight:"40sp"}}>-Lorem ipsum dolor sit amet consectetur. Urna tortor vitae sed nullam rutrum tortor. Sit at senectus diam eg</Typography>
