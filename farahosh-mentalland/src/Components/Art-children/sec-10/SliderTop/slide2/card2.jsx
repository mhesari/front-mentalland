...
const Card2 = ({ img,caption ,name,date , field}) => {
    return (
            ...
            <Box sx={{height:"400px",background:"white",width:{md:"80%",xs:"100%"},mb:4,boxShadow:"rgba(2, 151, 157, 0.1) 0px 8px 24px",borderTop:"5px solid #02979D","&:hover":{borderTop:"5px solid #024A9D",boxShadow:"rgba(2, 74, 157, 0.2) 0px 8px 24px",transform:"translateY(-1px)"}}}>
                ...
                <Typography sx={{fontFamily:"Gilroy-Regular" , fontSize:"17px",textAlign:"center" ,mt:3 ,px:{xs:6,md:1,lg:3,xl:6}}}>{caption}</Typography>
            </Box>
